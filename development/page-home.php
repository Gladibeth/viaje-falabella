      ...
      <?php while( $loop->have_posts() ) : $loop->the_post();?>
        <div class="main-banner__item">
          ...
          <div class="main-banner__img">
            ...
            ?>
            <img srcset="<?php the_post_thumbnail_url('480x792'); ?> 480w,<?php the_post_thumbnail_url('768x689'); ?> 768w,<?php the_post_thumbnail_url('555x360'); ?> 1024w,<?php the_post_thumbnail_url('1280x689'); ?> 1280w, <?php the_post_thumbnail_url(); ?> 1920w," alt="<?php echo $alt_banner_principal; ?>">
          </div>
        </div>
      <?php endwhile;
	      wp_reset_query();
