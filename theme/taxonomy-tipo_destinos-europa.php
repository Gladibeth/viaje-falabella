...
<section class="main-parallax">
  ...
  ?>
    <img class="img-round"
        srcset="<?php echo $image_sizes['480x792']; ?> 480w,<?php echo $image_sizes['768x689']; ?> 768w,<?php echo $image_sizes['555x360']; ?> 1280w,<?php echo $image['url']; ?> 1920w,"
        alt="<?php echo $image['alt']; ?>" style="width: 100%;height: 100%;object-fit: cover;">
            ...
            <ul class="nav nav-pills mb-3 tabs-left" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                        aria-controls="pills-home" aria-selected="true">Recomendaciones</a>
                </li>
                <span class="span_tabs">/</span>
                <li class="nav-item">
                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                        aria-controls="pills-profile" aria-selected="false">Paises</a>
                </li>
            </ul>
            <!-- <div class="destinations__tabs--paquetes">
                <ul class="nav nav-pills mb-3 tabs-right" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" target="_blank"
                            href=" <?php echo 'https://viajesfalabella.blog/paquetes-en-oferta/category/' . $taxonomy->slug; ?>">
                            <span><img alt="Icono Temporada"
                                    src="<?php bloginfo('template_url') ?>/assets/img/icons/Icono temporadas-1.svg"></span>
              ...
              $subcategories = get_categories(array(
                ...
                'post_status' => 'publish',
                            ...
                            <div class="main-articles__item">
                                <div class="mask"></div>
                                <a
                                    href="<?php echo bloginfo('url') . '/' . $sub_category->taxonomy . '/' . $sub_category->slug; ?>">
                                    <div class="main-articles__img">
                                        <?php
                      $image = get_field('image-category', $sub_category);
                      $image_sizes = $image['sizes'];
                      ?>
                                        <img class="img-round lazy"
                                            data-srcset="<?php echo $image_sizes['455x160']; ?> 768w,<?php echo $image_sizes['555x360']; ?> 1024w,<?php echo $image_sizes['555x360']; ?>"
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
              ...
              $subcategories = get_categories(array(
                ...
                'post_status' => 'publish',
                        ...
                        ?>
                                        <img class="img-round "
                                            srcset="<?php echo $image_sizes['455x160']; ?> 768w,<?php echo $image_sizes['555x360']; ?> 1024w,<?php echo $image_sizes['555x360']; ?>"
                                            alt="<?php echo $image['alt']; ?>">
                                    </div>
