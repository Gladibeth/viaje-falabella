        ...
        <div class="main-banner__item">
            ...
            <div class="main-banner__text">
                ...
                <div class=" btn-banner">
                    ...
                    <a href="https://viajesfalabella.blog/agenda-tu-cita/" target="_blank" class="btn-light">
                        Agenda aquí
                    </a>
            ...
            <!--  <a href="#formulario" data-toggle="modal" class="btn-light main-nav__mail btn-email-banner">
                <img alt="Icono Email" src="<?php bloginfo('template_url') ?>/assets/img/icons/email-white.svg"> Conoce
                nuestras ofertas
            ...
            <div class="main-banner__img">
                <?php
                    ...
                    ?>
                <img srcset="<?php the_post_thumbnail_url('480x792'); ?> 480w,<?php the_post_thumbnail_url('768x689'); ?> 768w,<?php the_post_thumbnail_url('555x360'); ?> 1024w,<?php the_post_thumbnail_url('1280x689'); ?> 1280w, <?php the_post_thumbnail_url(); ?> 1920w,"
                    alt="<?php echo $alt_banner_principal; ?>">
            </div>
        </div>
        <?php endwhile;
        wp_reset_query();
            ...
            <div class="main-slider__next">
                ...
                <div class="main-slider__box">
                    ...
                    <div class="main-slider__img">
                        <img class="main-slider__img--active" alt="<?php echo $alt_banner_secundario; ?>"
                    ...
                    <div class="slider-single">
                        <div style="display:grid; grid-template-columns: 50% 50%;" class="content">
                                ...
                                <div class="main-destiny__box">
                                    ...
                                    <div class="main-destiny__site">
                                        ...
                                        <div class="main-destiny__text">
                                            <a href="https://viajesfalabella.blog/viajes/vida-silvestre-en-africa/"
                            ...
                            <?php
                                    ...
                                    ?>
                            <img class="slider-single-image lazy" data-srcset="<?php echo $image_sizes['555x360']; ?>"
                ...
                <a href="<?php the_permalink(); ?>">
                    <div class="main-articles__img">
                        <?php
                            ...
                            ?>
                        <img class="lazy"
                            data-srcset="<?php the_post_thumbnail_url('455x160'); ?> 480w,<?php the_post_thumbnail_url('345x300'); ?> 768w,<?php the_post_thumbnail_url('555x360'); ?> 1024w,"
                            alt="<?php echo $alt_text_articulos; ?>">
                    </div>
